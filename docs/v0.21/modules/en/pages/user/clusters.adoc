...
[source,bash]
----
curl -s https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.21.0/examples/legacy/vsphere-rke2.yaml | envsubst > cluster1.yaml
----
+
...
[source,bash]
----
curl -s https://raw.githubusercontent.com/rancher/turtles/refs/tags/v0.21.0/examples/legacy/vsphere-kubeadm.yaml | envsubst > cluster1.yaml
----
+
. View **cluster1.yaml** and examine the resulting YAML file. You can make any changes you want as well.
+
