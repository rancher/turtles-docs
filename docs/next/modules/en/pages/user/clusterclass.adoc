...
The default description assigned to an imported Rancher is "CAPI cluster imported to Rancher".
image:imported-cluster-default-description.png[Imported Rancher Cluster with default description]

To add a custom description to the imported Rancher cluster, you may add `cluster-api.cattle.io/cluster-description` annotation to your CAPI cluster.
...
If a CAPI cluster is already imported, adding the annotation will do nothing. You may have to delete your imported Rancher cluster and re-import it, or simply add the description manually to its spec.
