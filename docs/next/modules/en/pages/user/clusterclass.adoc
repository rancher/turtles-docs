...
Docker Kubeadm::
+
* An Docker Kubeadm ClusterClass can be found among the https://github.com/rancher/turtles/tree/main/examples/clusterclasses[Turtles examples].
+
[source,bash]
----
...
spec:
  ...
  topology:
    ...
    classNamespace: creategitops-docker
    controlPlane:
      metadata: {}
...
Docker RKE2::
+
* An Docker RKE2 ClusterClass can be found among the https://github.com/rancher/turtles/tree/main/examples/clusterclasses[Turtles examples].
+
[source,bash]
----
...
spec:
  ...
  topology:
    ...
    classNamespace: creategitops-docker-rke2
    controlPlane:
      replicas: ${CONTROL_PLANE_MACHINE_COUNT}
    variables:
    - name: rke2CNI
