...
=== Installation with OCI artifact

As an administrator working in an air-gapped environment, you need to fetch the Azure Cluster API Provider (CAPZ) components from within your cluster since external internet access is restricted. This section demonstrates how to build, package, and deploy CAPZ using OCI artifacts stored in your private registry.
...
=== Installation with static manifest
