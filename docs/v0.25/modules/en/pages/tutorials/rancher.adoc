...
_If you're already running Rancher, you can skip this section and jump to xref:./first-cluster.adoc[Install {product_name}]._
...
Replace `<rancher-hostname>` with the actual hostname of your `Rancher` server and use the `--version` option to specify the version of `Rancher` you want to install.
